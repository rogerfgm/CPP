...
int main(){
	...
	vector<string> vs;
	vs.push_back("1,2,1,500000000,1 2,3,500000000,100000000");
	vs.push_back("0,1000000000");

	int ret = t.find(3, vs, 600000000);
